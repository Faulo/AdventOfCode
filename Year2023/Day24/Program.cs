...
Console.WriteLine($"{nameof(Runtime.sumOfStonePosition)} example-1.txt: {new Runtime("example-1.txt").sumOfStonePosition}");

Console.WriteLine($"{nameof(Runtime.sumOfStonePosition)} input.txt: {new Runtime("input.txt").sumOfStonePosition}");
